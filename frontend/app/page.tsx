...
// ── Ritual ceremony participants ──────────────────────────────────────────────
// Each figure is drawn as SVG inline with subtle animation offsets.
// The "floorboard" is the Ritual Chain logo colour scheme: dark charcoal with
// a faint grid / circuit-board texture.
...
// ── Ritual Chain Logo "floorboard" ─────────────────────────────────────────────
// Rendered as an SVG circuit-board / hex-grid pattern in Ritual green tones.
    ...
    <svg width={width} height={height} className="absolute bottom-0 left-0 opacity-30">
      <defs>
        <pattern id="hex" x="0" y="0" width="40" height="35" patternUnits="userSpaceOnUse">
          <polygon
            points="20,2 38,11 38,24 20,33 2,24 2,11"
            fill="none"
            stroke="#19D184"
            strokeWidth="0.8"
          />
...
export default function LandingPage() {
  ...
  // Positions for ritual participants — 8 figures arranged in a semicircle
  const figures = [
  ...
  return (
    <main className="relative min-h-screen overflow-hidden landing-mesh grain">
      ...
      <div className="relative w-full" style={{ height: dims.h }}>
        {/* Floorboard — Ritual Chain logo pattern */}
        ...
        >
          {/* Background ambient glow behind altar */}
          ...
          <line
            x1={cx - 340} y1={cy + 12}
            x2={cx + 340} y2={cy + 12}
            stroke="#374151" strokeWidth="1" opacity="0.4"
          />
          ...
          {/* Mystical connecting beams between altar and figures */}
      ...
      <div className="relative z-10 flex flex-col items-center text-center px-6 pt-2 pb-16">
        ...
        >
          Bridge your way to the astral plane
        </p>
        ...
        <div className="flex flex-col sm:flex-row gap-4 items-center">
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="px-8 py-4 border border-gray-600 text-gray-300 font-semibold text-base rounded-xl
